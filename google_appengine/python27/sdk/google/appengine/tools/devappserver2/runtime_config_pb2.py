...
_PHPCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='php_library_path', full_name='apphosting.tools.devappserver2.PhpConfig.php_library_path', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='php_composer_path', full_name='apphosting.tools.devappserver2.PhpConfig.php_composer_path', index=6,
