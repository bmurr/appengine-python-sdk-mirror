...
from google.appengine._internal.ruamel.yaml.error import YAMLError, FileMark, StringMark, YAMLStreamError
from google.appengine._internal.ruamel.yaml.compat import text_type, binary_type, PY3, UNICODE_SIZE
...
if False:  # MYPY
    ...
    from google.appengine._internal.ruamel.yaml.compat import StreamTextType  # NOQA
