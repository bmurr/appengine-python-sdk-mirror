...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.appengine.api.app_identity.app_identity_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n$com.google.appengine.api.appidentityB\024AppIdentityServicePb'
  _globals['_GETACCESSTOKENREQUEST'].fields_by_name['service_account_name']._loaded_options = None
  _globals['_GETACCESSTOKENREQUEST'].fields_by_name['service_account_name']._serialized_options = b'\030\001'
